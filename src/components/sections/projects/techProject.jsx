// src/components/sections/projects/TechProjects.js
import React from 'react';
import { Link } from 'react-router-dom';
import techProjects from './techProjectsData'; // Import the tech projects data
          ...
          {techProjects.map((project, index) => (
            ...
            >
              ...
              <p
                ...
                className="text-gray-600 text-sm mt-2 cursor-pointer hover:text-teal-500"
              >
                {project.description}
              </p>
